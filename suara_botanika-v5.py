...
if menu == "🏠 Beranda & Panduan":
    ...
    with col2:
        ...
        """, unsafe_allow_html=True)
        st.image("https://images.unsplash.com/photo-1516627145497-ae6968895b74?q=80&w=800", caption="Semua anak berhak belajar sains dengan gembira!", use_container_width=True)
...
# -----------------------------------------------------------------------------
    ...
    parts_data = {
        "Akar 🌱": {
            ...
            "image": "https://images.unsplash.com/photo-1595855759920-86582396756a?q=80&w=800"
        },
        "Batang 🪵": {
            ...
            "image": "https://images.unsplash.com/photo-1542273917363-3b1817f69a2d?q=80&w=800"
        },
        "Daun 🍃": {
            "title": "Daun (The Leaf)",
            ...
            "image": "https://images.unsplash.com/photo-1501004318641-724e611f5822?q=80&w=800"
        },
        "Bunga 🌸": {
        ...
        "Buah 🍎": {
            ...
            "image": "https://images.unsplash.com/photo-1619546813926-a78fa6372cd2?q=80&w=800"
        }
    }
    ...
    with tabs[0]:
        ...
        daun_types = {
            ...
            "Menjari 🍁": {
                ...
                "image": "https://images.unsplash.com/photo-1550950158-d0d960dff51b?q=80&w=800"
            },
            "Melengkung 🍃": {
            ...
            "Sejajar 🌾": {
                ...
                "image": "https://images.unsplash.com/photo-1545167622-3a6ac756afa4?q=80&w=800"
            }
        }
    ...
    with tabs[1]:
        ...
        batang_types = {
            ...
            "Batang Basah 🌿": {
                ...
                "image": "https://images.unsplash.com/photo-1557844352-761f2565b576?q=80&w=800"
            },
            "Batang Rumput 🌾": {
                ...
                "image": "https://images.unsplash.com/photo-1533240332313-0db49b439ad6?q=80&w=800"
            }
        }
    ...
    with tabs[2]:
        ...
        akar_types = {
            "Akar Serabut 🌾": {
                ...
                "image": "https://images.unsplash.com/photo-1551516594-c8c4ee56f901?q=80&w=800"
            },
            "Akar Tunggang 🌳": {
...
# -----------------------------------------------------------------------------
    ...
    with tabs_foto[0]:
        ...
        bahan_tersedia = {
            ...
            "Karbondioksida (CO2) 💨": {
                ...
                "image": "https://images.unsplash.com/photo-1518173946687-a4c8a383392e?q=80&w=800"
            },
            "Klorofil (Zat Hijau Daun) 🟢": {
                ...
                "image": "https://images.unsplash.com/photo-1516257984-b1b4d707412e?q=80&w=800"
            },
            "Kue Iwel-Iwel 🍽️": {
    ...
    with tabs_foto[1]:
        ...
        if os.path.exists(video_path):
            ...
            st.image("https://images.unsplash.com/photo-1508558934129-51d87ae000d4?q=80&w=800", caption="Fotosintesis: Sinar matahari menyinari dedaunan hijau", use_container_width=True)
    ...
    with col2:
        ...
        gen_data = {
            "Penyerbukan oleh Lebah": {
                ...
                "image": "https://images.unsplash.com/photo-1473081556163-2a17de81fc97?q=80&w=800"
            },
            "Penyerbukan oleh Angin": {
...
# -----------------------------------------------------------------------------
    ...
    with tabs_lokal[0]:
        ...
        with col2:
            st.image("https://images.unsplash.com/photo-1626132647523-66f5bf380027?q=80&w=800", caption="Kue Tradisional dibungkus Daun Pisang Nyata", use_container_width=True)
            st.markdown("""
            <div class="abk-card">
    ...
    with tabs_lokal[1]:
        ...
        with col2:
            st.image("https://images.unsplash.com/photo-1507608869274-d3177c8bb4c7?q=80&w=800", caption="Lampion Tradisional Damar Kurung yang bersinar indah", use_container_width=True)
            st.markdown("""
            <div class="abk-card">
...
# -----------------------------------------------------------------------------
    ...
    questions = [
        ...
        },
        {
            ...
            "image": "https://images.unsplash.com/photo-1508558934129-51d87ae000d4?auto=format&fit=crop&w=800&q=80",
            "options": [
